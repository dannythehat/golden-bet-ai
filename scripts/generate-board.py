...
TEAM_NAME_EXPANSIONS = {'KA': 'Akureyri', 'KA Akureyri': 'Akureyri', 'ÍA': 'Akranes', 'ÍA Akranes': 'Akranes', 'ÍBV': 'Vestmannaeyjar', 'ÍBV Vestmannaeyjar': 'Vestmannaeyjar', 'FH': 'Hafnarfjördur', 'FH Hafnarfjördur': 'Hafnarfjördur', 'KR': 'KR Reykjavík', 'Fram': 'Fram Reykjavík', 'Thór': 'Thór Akureyri', 'Valur': 'Valur Reykjavík', 'Víkingur': 'Víkingur Reykjavík', 'KV': 'KV Reykjavík', 'HK': 'Kópavogur', 'Throttur': 'Throttur Reykjavík', 'VPS': 'Vaasa', 'VPS Vaasa': 'Vaasa', 'KTP': 'Kotka', 'KTP Kotka': 'Kotka', 'SJK': 'Seinäjoki', 'SJK Seinäjoki': 'Seinäjoki', 'JäPS': 'Järvenpää', 'JäPS Järvenpää': 'Järvenpää', 'KäPa': 'Käpylä', 'KäPa Helsinki': 'Käpylä', 'KuPS': 'Kuopio', 'KuPS Kuopio': 'Kuopio', 'MP': 'Mikkeli', 'MP Mikkeli': 'Mikkeli', 'EIF': 'Ekenäs', 'EIF Ekenäs': 'Ekenäs', 'JIPPO': 'Jippo Joensuu', 'JIPPO Joensuu': 'Jippo Joensuu', 'TPS': 'TPS Turku', 'HJK': 'HJK Helsinki', 'Haka': 'FC Haka', 'Lahti': 'FC Lahti', 'Oulu': 'AC Oulu', 'Inter': 'FC Inter Turku', 'KFUM': 'Oskarshamn', 'KFUM Oskarshamn': 'Oskarshamn', 'Brage': 'IK Brage', 'Öster': 'Östers IF', 'AIK': 'AIK Stockholm', 'Trans': 'Trans Narva', 'Elva': 'FC Elva', 'Zemun': 'FK Zemun', 'Argeș': 'FC Argeș'}
def xn(name):

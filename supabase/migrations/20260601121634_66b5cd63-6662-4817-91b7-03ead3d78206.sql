-- One-shot backfill of referee features on training v2 from existing labelled history.
-- Aggregates per referee_key from v2 itself (where total_cards is settled), then UPDATEs.
...
-- Reusable function for cron to repopulate as more rows settle / new referees appear.
